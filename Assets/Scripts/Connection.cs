...
public class Connection : MonoBehaviour
{
    ...
    private int _bufferSize = 1024; //in bytes
    private byte[] _buffer; //inaccessable data
    ...
    //PUBLIC FUNCTIONS
    /// <summary> Returns value from player prefs. If doesn't exist then returns 7777.</summary>
    ...
    /// <summary> Returns value from player prefs. If don't exist then returns 127.0.0.1.</summary>
    ...
    /// <summary> IP in PlayerPrefs "IpServ", PORT in PlayerPrefs "Port" </summary>
    ...
    /// <summary> If connection is active returns true</summary>
    ...
    /// <summary> Buffer size for data exchange</summary>
    ...
    /// <summary> Returns last messages if there were any </summary>
    ...
    public void _Server_Callback(System.IAsyncResult Result)
    {
        ...
        if (_TcpClient.Connected) // Checking if connected
        {
            ...
            _listener.BeginAcceptTcpClient(new System.AsyncCallback(_Server_Callback), null); //?????? <- Check later
            _Start_Listening();
        }
    }
